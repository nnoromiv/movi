      ...
      >
        {({ handleBlur, handleChange, handleSubmit, isValid, values}) => (
            <>
                ...
                />
                <PrimaryButton buttonStyle={styles.button} buttonText='Sign up' disabled={!isValid} buttonFunc={handleSubmit}/>
                ...
                <Icon textName={"Already have an account?"}/>
                <Icon textName={' Log in'} textStyle={letYouInStyles.signUp} press={() => navigation.push('LetYouInScreen')}/>
                </View>
            </>
        )}
      </Formik>
